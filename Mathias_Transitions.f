	...
	double precision ccKo, ccKi, ccNao, ccNai, ccClo, ccCli, ccCao, ccCai,ccMgo
	double precision a1,b1,a2,b2,a3,b3,a4,a5,b5
	double precision m2,m4,m6,m7,m8,h9
	double precision ti0
	...
	xx(1)= -45.0;	
	xx(2)=0.51  + 0.000001;
	xx(3)=0.51 + 0.000001;	xx(4)=0.54 + 0.000002;	xx(5)=0.51 + 0.500001;	xx(6)=0.51 + 0.000002;	
	xx(7)=0.51 + 0.000001;	xx(8)=0.51 + 0.000001;	xx(9)=0.51 + 0.500001;
	xx(10) = 0.5 + 0.000001;
	...
	if (icont.gt.cl) then
	   write(36,*) ti,xx(1),xx(2),xx(3),xx(4),xx(5),xx(10)
	   cl=cl+1
	end if
   10	continue
      stop
	...
	ccKo=(3.9 + 0.05*k1)*1000; ccKi = 140*1000; 
        ccNao=140*1000; ccNai=7.*1000;
	ccClo=140*1000; ccCli=7*1000; 
        ccCao=(1.35 - 0.015*k1)*1000; 
	ccMgo = (0.8 - 0.01*k1)*1000;
	ccCai = xx(10)
